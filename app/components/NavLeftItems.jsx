  ...
  return (
    <>
      ...
      <ul className="buttons">
        <li onClick={() => handleModal("modalGoogleForm")} className="button">
          GET PROMOTED
        </li>
      </ul>
      ...
      <Modal
        id="modalSidenavMore"
        isOpen={modals["modalSidenavMore"]}
        ...
        <aside className="modal-popup modal-share">
          ...
          <section>
            <ul class="buttons-vertical">
              <li
                class="icon-text-horizontal"
                onClick={() => handleModal("modalSidenavMore")}
              >
                <span class="icon-horizontal">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
